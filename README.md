...
Hier werden unterschiedliche Herangehensweisen der Erstellung von Microservices und einem API-Gateway mit GraphQL erläutert. Zunächst wird auf die "altmodische" Art des manuellen Schema-Stitchings in einem API-Gateway eingegangen und anschließend die Herangehensweise mit Apollo-Federation erläutert, welche am 30.05.2019 in seiner ersten Form veröffentlicht wurde. Da Federation noch nicht vollständig Implementiert ist (noch nicht alle Anforderungen umgesetzt), ist diese Technologie noch nicht produktiv einsetzbar, wird hier jedoch aufgrund der sehr innovativen und hilfreichen Grundidee erläutert. Zur Erläuterung wird jeweils das selbe Beispiel umgesetzt, welches wie folgt aussieht:
...
Nun ist das Gateway vollständig einsatzbereit.
